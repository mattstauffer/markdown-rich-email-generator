      ...
      <table class="header centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;width: 602px">
        ...
        <tr><td class="logo" style="padding: 32px 0;vertical-align: top;mso-line-height-rule: at-least"><div class="logo-center" style="font-size: 26px;font-weight: 700;letter-spacing: -0.02em;line-height: 32px;color: #41637e;font-family: sans-serif;text-align: center" align="center" id="emb-email-header"><img style="border: 0;-ms-interpolation-mode: bicubic;display: block;Margin-left: auto;Margin-right: auto;max-width: 900px" src="https://i1.yoursenddomain.com/ei/i/CA/BAE/047/040317/csfinal/tmp1.jpg" alt="" width="600" height="226"></div></td></tr>
          ...
          <table class="centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto">
            ...
            <h1 style="Margin-top: 0;color: #565656;font-weight: 700;font-size: 36px;Margin-bottom: 18px;font-family: sans-serif;line-height: 42px">Start designing your email</h1><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">Add new pieces of content like text, images and buttons to your email by dragging the tiles on the left where you want them to go.</p><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 24px">Add different layouts to your email by clicking on the green <strong style="font-weight: bold">Add layout</strong> button below.</p>
          ...
          <table class="centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto">
            ...
            <h1 style="Margin-top: 0;color: #565656;font-weight: normal;font-size: 52px;Margin-bottom: 22px;font-family: sans-serif;text-align: center;line-height: 58px">Article</h1>
            ...
            <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 21px;line-height: 32px;Margin-bottom: 32px;text-align: center">Nunc et mattis ante, non sodales metus. Pha sellus placerat scele risque tellus eu male suada. Pellen tesque habitant morbi tris tique sen ectus et netus et malesuada.</p>
          ...
          <table class="centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto">
            ...
            <h1 style="Margin-top: 0;color: #565656;font-weight: 700;font-size: 20px;Margin-bottom: 12px;font-family: sans-serif;line-height: 26px">Article</h1><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 12px;line-height: 21px;Margin-bottom: 21px">Quisque at cursus nisi, non rutrum massa. Aenean consectetur velit faucibus mauris posuere aliquet.</p>
            ...
            <h1 style="Margin-top: 0;color: #565656;font-weight: 700;font-size: 20px;Margin-bottom: 12px;font-family: sans-serif;line-height: 26px">Article</h1><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 12px;line-height: 21px;Margin-bottom: 21px">Praesent varius eleifend rhoncus. Mauris porta met us lacus, sit amet ullam corper nulla scele.</p>
            ...
            <h1 style="Margin-top: 0;color: #565656;font-weight: 700;font-size: 20px;Margin-bottom: 12px;font-family: sans-serif;line-height: 26px">Article</h1><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 12px;line-height: 21px;Margin-bottom: 21px">Praesent feugiat mauris ante, ut elei fend ante dictum vitae. Vesti bulum pellen tesque ante nec.</p>
                  ...
                  <table style="border-collapse: collapse;border-spacing: 0">
                    <tbody><tr>
                      ...
                      <td class="social-text" style="padding: 0;vertical-align: middle !important;height: 21px;font-size: 10px;font-weight: bold;text-decoration: none;text-transform: uppercase;color: #999;letter-spacing: 0.05em;font-family: Georgia,serif">
                        <a style="text-decoration: none;transition: all .2s;color: #999;letter-spacing: 0.05em;font-family: Georgia,serif" href="/t/i-fb-jlukjiy-l-j/?act=wv" rel="cs_facebox" cs_likeurl="/t/i-fb-jlukjiy-l-j/?act=like" target="_blank">
                          Like
                        </a>
                      </td>
                    </tr>
                ...
                <td class="social-link" style="padding: 0;vertical-align: top">
                  <table style="border-collapse: collapse;border-spacing: 0">
                    <tbody><tr>
                      ...
                      <td class="social-text" style="padding: 0;vertical-align: middle !important;height: 21px;font-size: 10px;font-weight: bold;text-decoration: none;text-transform: uppercase;color: #999;letter-spacing: 0.05em;font-family: Georgia,serif">
                        <a style="text-decoration: none;transition: all .2s;color: #999;letter-spacing: 0.05em;font-family: Georgia,serif" href="http://tightenco.forwardtomyfriend.com/i-l-2AD73FFF-jlukjiy-l-h" lang="en" target="_blank">
                          Forward
                        </a>
                      </td>
                    </tr>
                  ...
                  <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                    <tbody><tr>
                      <td class="padded" style="padding: 0;vertical-align: top;padding-left: 0;padding-right: 10px;word-break: break-word;word-wrap: break-word;text-align: left;font-size: 12px;line-height: 20px;color: #999;font-family: Georgia,serif">
                        <div>@stauffermatt on twitter<br>
mattstauffer.co</div>
                      </td>
                    </tr>
                  </tbody></table>
                  ...
                  <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                    <tbody><tr>
                      <td class="padded" style="padding: 0;vertical-align: top;padding-left: 10px;padding-right: 0;word-break: break-word;word-wrap: break-word;font-size: 12px;line-height: 20px;color: #999;font-family: Georgia,serif;text-align: right">
                        <div>You're receiving this email because you signed up for it at mattstauffer.co</div>
                        <div>
                          <span class="block">
                            <span>
                              <a style="font-weight: bold;text-decoration: none;transition: all .2s;color: #999" href="http://tightenco.updatemyprofile.com/i-l-2AD73FFF-l-k" lang="en" target="_blank">
                                Preferences
                              </a>
